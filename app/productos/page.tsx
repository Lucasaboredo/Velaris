          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16">
            {products.map((product) => (
              <div key={product.id} className="group flex flex-col items-center reveal">
                <div className="w-full max-w-sm aspect-[4/5] overflow-hidden bg-stone-200 mb-5 md:mb-6 rounded-sm shadow-md group-hover:shadow-2xl transition-all duration-700 relative">
                  <img
                    src={product.image}
                    alt={product.name}
