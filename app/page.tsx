...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#222] font-sans selection:bg-stone-200">
      ...
      {/* HERO SECTION - LOGO GIGANTE Y ELEVADO */}
      ...
      <section className="bg-white py-20 md:py-32 px-6 reveal">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[
            { t: "Sustentabilidad", d: "Cera de soja 100% natural y ecológica.", i: "M12 21v-8m0 0A8.997 8.997 0 0019 6a8.997 8.997 0 00-7 7m0 0A8.997 8.997 0 005 6a8.997 8.997 0 007 7z" },
            { t: "Esencias Premium", d: "Fragancias intensas que perduran.", i: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" },
            { t: "Hecho a Mano", d: "Artesanía pura desde Colón, Entre Ríos.", i: "M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" }
          ].map((val, idx) => (
            <div key={idx} className="p-8 bg-[#FDFBF7] rounded-3xl border border-stone-100 hover:shadow-2xl transition-all duration-700 group">
              <div className="w-12 h-12 mb-6 text-stone-800 mx-auto group-hover:scale-110 transition-transform duration-500">
                <svg fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24"><path d={val.i} /></svg>
              </div>
              <h4 className="text-sm font-bold tracking-[0.2em] uppercase mb-4 text-stone-950">{val.t}</h4>
              <p className="text-stone-500 text-xs md:text-sm font-light leading-relaxed">{val.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="cuidados" className="bg-white py-24 md:py-32 px-6 reveal">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="flex-1 w-full order-1 md:order-2">
            <img
              src="/2.jpeg"
              className="rounded-[2rem] shadow-2xl hover:scale-[1.01] transition-transform duration-700 grayscale-[20%] hover:grayscale-0"
              alt="Cuidado de vela"
            />
          </div>
        </div>
      ...
      {/* SECCIÓN INSTAGRAM - SOLO LOGO QUE REDIRIGE */}
