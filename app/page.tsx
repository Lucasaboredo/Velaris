...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#222] font-sans selection:bg-stone-200">
      ...
      {/* HERO SECTION - LOGO AJUSTADO PARA MOBILE */}
      <section className="relative w-full aspect-[4/5] md:aspect-[21/9] max-h-[85vh] flex items-center justify-center overflow-hidden reveal bg-stone-200">
        ...
        {/* CONTENEDOR DEL LOGO - Ajustes de tamaño y posición para mobile */}
        {/* Mobile: h-40 y -translate-y-28 (más chico y más abajo) */}
        {/* Desktop (md): Recupera tamaño h-80 y posición fija arriba top-20 */}
        <div className="relative z-10 flex flex-col items-center animate-fade-in px-4 -translate-y-28 md:absolute md:top-20 md:translate-y-0 overflow-hidden">
          <img
            src="/logo.jpeg"
            alt="Logo Velaris"
          ...
          <div className="flex-1 text-center md:text-left order-2 md:order-1">
            ...
            <div className="space-y-8 max-w-lg mx-auto md:mx-0">
              {[
                ...
                "Apaga ahogando la llama, nunca sopler."
              ].map((tip, i) => (
